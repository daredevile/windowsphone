...
namespace SoundBoard.ViewModels
{
    public class SoundModel
    {
        ...
        { 
        // load data inti the model

            Animals = CreateAnimalsGroups();
        ...
        private SoundGroup LoadCustomSounds()
        {
            ...
            if (IsolatedStorageSettings.ApplicationSettings.TryGetValue(CustomSoundKey, out dataFromAppSetting))
            {
                data = JsonConvert.DeserializeObject<SoundGroup>(dataFromAppSetting);
            }
            else {
        ...
        private SoundGroup CreateAnimalsGroups()
        {
